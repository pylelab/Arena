...
if __name__ == '__main__':
	...
	#normalize_structure(sys.argv[3])
	
	# calculate RMSD for RNA structures
	# require biopython
	# native_file, native_index, prediction_file, prediction_index
	print(calc_RMSD(sys.argv[1],
			  sys.argv[2],
			  sys.argv[3],
			  sys.argv[4]))
	...
	# native_file, native_index, prediction_file, prediction_index
	print(InteractionNetworkFidelity(sys.argv[1],
			  sys.argv[2],
			  sys.argv[3],
			  sys.argv[4]))
